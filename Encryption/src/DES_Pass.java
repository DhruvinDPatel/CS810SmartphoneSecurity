...
public class DES_Pass {
	 ...
	 * @throws DES_Pass.InvalidPasswordException
	 *   if the given password was not used to encrypt the data
	 * @throws DES_Pass.InvalidAESStreamException
	 *   if the given input stream is not a valid AES-encrypted stream
	 * @throws DES_Pass.StrongEncryptionNotAvailableException
